...
class Graphs{
	public:
		...
		Graphs(string nameFile, string title, int size)
		{
			...
			gp << "set style line 3 lc rgb '#00c10c' lt 1 lw 3 pt 7 ps 1.5\n"; // Orange line
			gp << "set style line 4 lc rgb '#c100aa' lt 1 lw 3 pt 7 ps 1.5\n"; // Green line
			gp << "set style line 5 lc rgb '#c15200' lt 1 lw 3 pt 7 ps 1.5\n"; // Purple line
			gp << "set style line 6 lc rgb '#00b5c1' lt 1 lw 3 pt 7 ps 1.5\n"; // Yellow line
			gp << "set style line 7 lc rgb '#c1bb00' lt 1 lw 3 pt 7 ps 1.5\n"; // Cyan line
